      ...
      <div className="w-[780px]">
        ...
        <div className="max-[900px]:flex-col flex items-center justify-between w-full mt-2 text-center max-[450px]:px-16">
          <div>
            ...
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSexWEghOafLrVeLYZOT7wnGxBQEsE5aH_Seby-MCeX5iLjTwQ/viewform?usp=sf_link"
          ...
          <div>
            ...
            <a
              href="mailto:patriothacksgmu@gmail.com"
              className="text-white text-sm underline"
            >
        ...
        <div className="mt-4 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-white text-xs underline hover:text-gray-300 transition-colors"
          >
            MLH Code of Conduct
          </a>
        </div>
